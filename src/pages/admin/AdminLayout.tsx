    ...
    <div className="admin-shell">
      ...
      <aside className={`admin-sidebar${sidebarOpen ? ' is-open' : ''}`} id="admin-sidebar" aria-label="Admin navigation">
        ...
        <nav>
          ...
          <Link to="/admin/payments" style={{ ...sidebarLinkStyle, ...(location.pathname.startsWith('/admin/payments') ? activeLinkStyle : {}) }}>Payments</Link>
          <Link to="/admin/shippings" style={{ ...sidebarLinkStyle, ...(location.pathname.startsWith('/admin/shippings') ? activeLinkStyle : {}) }}>Shipping</Link>
