                    ...
                    <div className="stats-grid">
                        <div className="stat-card modern">
                            ...
                            <div className="stat-content">
                                ...
                                <div
                                    className="stat-label">{t('stats.models', {defaultValue: 'Unikátnych modelov'})}</div>
                        ...
                        <div className="stat-card modern">
                            ...
                            <div className="stat-content">
                                ...
                                <div
                                    className="stat-label">{t('stats.customers', {defaultValue: 'Spokojných zákazníkov'})}</div>
                        ...
                        <div className="stat-card modern">
                            ...
                            <div className="stat-content">
                                ...
                                <div
                                    className="stat-label">{t('stats.monthly', {defaultValue: 'Nových modelov mesačne'})}</div>
                        ...
                        <div className="stat-card modern">
                            ...
                            <div className="stat-content">
                                ...
                                <div
                                    className="stat-label">{t('stats.download', {defaultValue: 'Okamžité stiahnutie'})}</div>
                            ...
                            <div className="profile-info">
                                ...
                                <div className="profile-badges">
                                    <div className="profile-badge">
                                        ...
                                        <span
                                            className="badge-text">{t('creator.experience', {defaultValue: '5+ rokov skúseností'})}</span>
                                    </div>
                                    <div className="profile-badge">
                                        <span className="badge-icon">🎯</span>
                                        <span
                                            className="badge-text">{t('creator.models', {defaultValue: '500+ modelov'})}</span>
                                    </div>
                                    <div className="profile-badge">
                                        <span className="badge-icon">💬</span>
                                        <span
                                            className="badge-text">{t('creator.personal', {defaultValue: 'Osobná podpora'})}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
