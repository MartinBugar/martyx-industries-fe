...
import { adminProductsService, type BaseProduct, type DigitalProduct, type PhysicalProduct } from '@/lib/services/adminProductsService';
...
const AdminProductDetail: React.FC = () => {
  ...
  const navTabs = (
    <div className="admin-nav-tabs">
      ...
      <Link
        href={`/admin/products/${id}/gallery`}
