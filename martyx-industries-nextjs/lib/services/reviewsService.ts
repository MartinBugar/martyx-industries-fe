...
export const reviewsService = {
  async getReviews(productId: string | number, language?: string): Promise<Array<Review & { displayName: string; createdAt: string }>> {
  ...
  async addReview(productId: string | number, payload: ReviewCreateRequest, language?: string): Promise<Review & { displayName: string; createdAt: string }> {
  ...
  async deleteReview(productId: string | number, reviewId: string | number, language?: string): Promise<void> {
